...
// $config['base_url'] = 'http://localhost/loan-monitoring/';

// $config['base_url'] = ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on') ? "https" : "http");
// $config['base_url'] .= "://" . $_SERVER['HTTP_HOST'];
// $config['base_url'] .= str_replace(basename($_SERVER['SCRIPT_NAME']), "", $_SERVER['SCRIPT_NAME']);
// $config['base_url'] = 'https://loan-monitoring.alwaysdata.net/';
// $config['base_url'] = 'https://loan-monitoring.alwaysdata.net/bms/'; balik og mo bayad na
$config['base_url'] = 'https://bms.page.gd/bms/';
/*
|--------------------------------------------------------------------------
| Index File
|--------------------------------------------------------------------------
